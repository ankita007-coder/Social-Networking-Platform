...
const Profile = () => {
  ...
  const handleProfilePictureUpload=async(e)=>{
    ...
    formData.append('profilePicture', selectedFile); // 'profilePicture' should match the name attribute in the Multer middleware
  
    try {
      const response = await axios.post('http://localhost:8000/api/v1/users/profile/profile-picture', formData, {
        headers: {
